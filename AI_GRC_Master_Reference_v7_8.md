# AI GRC Master Reference File: Version 7.8
...
**Enforcement timeline.** The penalty tiers attach to their corresponding obligations as those obligations enter application. As of this version (July 2026), the enacted text sets August 2, 2026 as the application date for Annex III high-risk obligations; the digital omnibus regulation, approved by the European Parliament on June 16, 2026 and adopted by the Council on June 29, 2026, moves the date to December 2, 2027 for stand-alone Annex III systems and August 2, 2028 for AI systems embedded in products, and enters into force on the third day after its pending Official Journal publication. Until that publication, the enacted dates remain binding. Confirm the current schedule against the primary source before advising on enforcement exposure.
