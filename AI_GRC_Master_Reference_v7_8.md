...
**Enforcement timeline.** The penalty tiers attach to their corresponding obligations as those obligations enter application. As of this version (July 2026), the enacted text sets August 2, 2026 as the application date for Annex III high-risk obligations; a provisional digital omnibus agreement, approved by the European Parliament on June 16, 2026 and awaiting Council adoption and Official Journal publication, would move the date to December 2, 2027 for stand-alone Annex III systems and August 2, 2028 for AI systems embedded in products. Until publication in the Official Journal, the enacted dates remain binding. Confirm the current schedule against the primary source before advising on enforcement exposure.
